...
The measurements consist of left and right ear [impulse response](https://en.wikipedia.org/wiki/Impulse_response)s (IRs) from a TASCAM VL-S3 loudspeaker placed about 1.5m from the center of the dummy head.
